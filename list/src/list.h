...
public:
    ...
    public:
        ...
        iterator operator++(int) { iterator t(*this); ptr->next; return t; }
        reference operator*() const { return (ptr->val); }
        pointer operator->() const { return &(ptr->val); }
        iterator& operator--() { ptr = ptr->prev; return *this; }
        iterator operator--(int) { iterator t(*this); ptr->prev; return t; }
    ...
    private:
        ...
        explicit const_iterator (pointer ptr_val) { ptr = Node<value_type>(ptr_val); }
        pointer_node get_node_pointer() { return ptr; }
    public:
        ...
        const_iterator operator++(int) { const_iterator t(*this); ptr->next; return t; }
        reference operator*() const { return (ptr->val); }
        pointer operator->() const { return &(ptr->val); }
        const_iterator& operator--() { ptr = ptr->prev; return *this; }
        const_iterator operator--(int) { const_iterator t(*this); ptr->prev; return t; }
...
private:
    ...
    void _count_default_constructor_base (
            size_t count, 
            const Allocator& alloc = Allocator()
            )
    {
...
public:
    ...
    iterator insert(const_iterator pos, T&& value) {
        ...
        if (_front == pos.get_node_pointer())
            _front = node;
        _add_node(node, next);
        _size += 1;
